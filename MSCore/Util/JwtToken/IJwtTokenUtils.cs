...
namespace MSCore.Util.JwtToken
{
    public interface IJwtTokenUtils
    {
        ...
        /// <returns></returns>
        System.Object getToken<T>(T t, IEnumerable<Claim> claims = null, SecurityToken validateToken = null, string keyCode = "userCode");
        ...
        /// <returns></returns>
        System.Object refresh<T>(RefreshModel refreshModel, T t, IEnumerable<Claim> claims = null);
    }
}
