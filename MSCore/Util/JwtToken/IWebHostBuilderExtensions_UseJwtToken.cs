...
namespace MSCore.Util.JwtToken
{
    public static class IWebHostBuilderExtensions_UseJwtToken
    {
        ...
        /// <returns></returns>
        public static IWebHostBuilder UseMSCoreJwtTokenServer(this IWebHostBuilder builder, IConfiguration configuration)
        {
                ...
                services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
                {
                    ...
                    options.Events = new JwtBearerEvents
                    {
                        OnChallenge = async context =>
                        {
                            ...
                            var response = new { message = "You are not authenticated." };
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        public static IWebHostBuilder UseMSCoreJwtTokenClient(this IWebHostBuilder builder, IConfiguration configuration)
        {
            builder.ConfigureServices(delegate (IServiceCollection services)
            {
                services.AddSingleton<IJwtTokenUtils, JwtTokenUtils>();
