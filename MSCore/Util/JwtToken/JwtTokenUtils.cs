...
namespace MSCore.Util.JwtToken
{
    public class JwtTokenUtils : IJwtTokenUtils
    {
        ...
        /// <returns></returns>
        public System.Object getToken<T>(T t, IEnumerable<Claim> claims = null, SecurityToken validateToken = null, string userCode = "userCode")
        {
            if (claims == null)
            {
        ...
        /// <returns></returns>
        public System.Object refresh<T>(RefreshModel refreshModel, T t, IEnumerable<Claim> claims = null)
        {
            var algorithmsType = _configuration["JWT:AlgorithmsType"];
            ...
            var view = getToken(t, claims, validatedToken);
