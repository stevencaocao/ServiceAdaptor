...
namespace MSCore.Util.Common
{
    public class Serialization_Newtonsoft : ISerialization
    {
        ...
        public readonly JsonSerializerSettings serializeSetting = new JsonSerializerSettings();
        ...
        public Serialization_Newtonsoft()
        {
            ...
            serializeSetting.DateFormatHandling = DateFormatHandling.IsoDateFormat;
        ...
        {
            return SerializeToBytes(obj, null);
        }
